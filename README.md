...
```shell
opctl pkg install github.com/opspec-pkgs/azure.apimanagement.properties.set#2.1.0
```
...
```yaml
op:
  pkg: { ref: github.com/opspec-pkgs/azure.apimanagement.properties.set#2.1.0 }
  inputs:
    subscriptionId:
    loginId:
    loginSecret:
